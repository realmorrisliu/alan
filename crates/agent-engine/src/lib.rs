...
pub use agent_root::{
    ...
    workspace_persona_dir_from_alan_dir, workspace_public_skills_dir,
    ...
    workspace_runtime_sessions_dir, workspace_runtime_sessions_dir_from_alan_dir,
    workspace_runtime_shell_restore_dir_from_alan_dir, workspace_runtime_tmp_dir_from_alan_dir,
    workspace_session_read_dirs_for_channel_from_alan_dir, workspace_sessions_dir,
    workspace_sessions_dir_for_channel_from_alan_dir, workspace_sessions_dir_from_alan_dir,
