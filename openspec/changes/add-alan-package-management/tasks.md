...
- [ ] 6.6 Cover uninstall exactness (manifest-only deletion, diverged-file preservation, unmanifested-file preservation, non-empty entry retention, and forced whole-entry removal) and list output for missing tools, runtime capabilities, environment dependencies, version gates, and unresolved execution
