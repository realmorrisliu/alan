> **SUPERSEDED.** The accepted `alan-app-service-integration` requirements are
> folded into `remove-daemon-era-contracts`. Archive this change without
> synchronizing its independent delta.
