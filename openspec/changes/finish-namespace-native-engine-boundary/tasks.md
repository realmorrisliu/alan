...
- [ ] 5.1 Implement child observation over `/proc/<pid>/status`, `io/output`, request/action streams, `machine/ui/events`, and `machine/ui/activity` freshness with resumable offsets/timestamps.
