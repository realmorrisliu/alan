...
- [x] 8.1 Submit the implementation as its own PR and complete current-HEAD Codex review, zero unresolved threads, green CI, and delayed recheck
- [x] 8.2 After merge, sync every delta into canonical specs and remove superseded workspace capability text
