# content-addressed-knowledge Specification

## Purpose
Define the content-addressed knowledge store that backs tape, memory, and
context with deduplication, checkpoint roots, cheap forks, integrity
