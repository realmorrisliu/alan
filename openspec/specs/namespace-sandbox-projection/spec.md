# namespace-sandbox-projection Specification

## Purpose
Define how a single host-backed mount declaration list projects into both Alan OS
namespace authority and native subprocess sandbox enforcement.
## Requirements
